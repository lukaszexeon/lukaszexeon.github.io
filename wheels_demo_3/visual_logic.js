 ...
 * Fri Oct 02 2020 17:09:18 GMT+0200 (czas środkowoeuropejski letni)
...
var frontWheelsList, wheelsFront, currentWidth;
...
eventHTMLElem('change', 'myRange', true, function(event) {
  currentWidth = getHTMLElemAttribute('value', 'myRange', true) / 100;
  setMorphFactor('doors', 'width', currentWidth);
  if (wheelsFront == 2 && currentWidth < 0.7) {
    currentWidth = 0.7;
    setMorphFactor('doors', 'width', currentWidth);
  } else {
  }
...
eventHTMLElem('click', 'front_two_wheels', true, function(event) {
  if (wheelsFront == 1) {
    frontWheelsList = cloneObject('wheel.000');
    setObjTransform(frontWheelsList, 'position', 0, 3, 0, true);
    setObjTransform('wheel.000', 'position', 0, -3, 0, true);
  } else {
  }
  wheelsFront = 2;
  if (currentWidth < 0.8) {
...
eventHTMLElem('click', 'front_sigle_wheel', true, function(event) {
  if (wheelsFront == 2) {
    removeObject(frontWheelsList);
    frontWheelsList = [];
    setObjTransform('wheel.000', 'position', 0, 3, 0, true);
  } else {
  }
